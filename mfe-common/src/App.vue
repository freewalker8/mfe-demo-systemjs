<template>
  <div id="app">
    <div id="wst-common-top">
      ...
      <ul id="wst-common-top__quickmenu">
        <li class="pointer"><i class=""></i><span>退出登录</span></li>
      </ul>
    </div>
